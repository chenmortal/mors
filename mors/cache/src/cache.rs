...
impl<B: Block, T: TableIndexBuf> Cache<B, T> for MorsCache<B, T> {
...
impl<B: Block, T: TableIndexBuf> CacheBuilder<MorsCache<B, T>, B, T>
...
impl<B: Block, T: TableIndexBuf> MorsCache<B, T> {
